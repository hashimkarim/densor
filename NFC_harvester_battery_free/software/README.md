...
The [byte protocol](docs/r1-protocol.md) defines the 128-byte metadata map,
...
Inspect the map, `.su` reports and [stack review](docs/r1-stack-review.md)
together; those reservations are not a measured runtime stack margin.

Candidate artifacts are generated in [`build/r1-candidate`](build/r1-candidate):
...
[Phone checks](docs/android-phone-tests.md) cover APK installation/launch and
